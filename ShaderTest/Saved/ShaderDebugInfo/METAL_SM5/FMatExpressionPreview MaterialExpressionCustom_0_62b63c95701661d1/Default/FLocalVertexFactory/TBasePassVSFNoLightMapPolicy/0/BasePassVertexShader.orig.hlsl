// DebugHash_43dac091ec82eb34794e65843ed9f87cd40ceb6677c8fb5c0c1e9d6ecf28dadc
...
_Pragma("dxc diagnostic ignored \"-Wall\"") 					_Pragma("dxc diagnostic ignored \"-Wconversion\"") 				_Pragma("dxc diagnostic ignored \"-Wfor-redefinition\"") 		_Pragma("dxc diagnostic ignored \"-Winline-asm\"")				_Pragma("dxc diagnostic ignored \"-Wunsequenced\"")
	...
	float3 Local1 = max(Local0,((float3)0.00000000));
	float3 Local2 = PositiveClampedPow(Local1,((float3)0.45454544));
	...
	PixelMaterialInputs.Refraction = float3(float3(1.00000000,0.0f,0.0f).xy,Material_PreshaderBuffer[0].x);
